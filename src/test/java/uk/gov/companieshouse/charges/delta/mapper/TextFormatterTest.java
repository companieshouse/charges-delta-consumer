...
class TextFormatterTest {
    ...
    private static Stream<Arguments> particularsFormatting() {
        return Stream.of(
                ...
                Arguments.of("this is a sentence that contains sequence AB.1234. sentence casing should apply after the full stop", "This is a sentence that contains sequence ab.1234. Sentence casing should apply after the full stop."),
                Arguments.of("Hello\\n\\nWorld", "Hello. World."),
                Arguments.of("Hello\\n \\n \\nWorld", "Hello. World."),
