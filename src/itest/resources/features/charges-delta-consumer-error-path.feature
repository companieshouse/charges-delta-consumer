Feature: Process Charges Delta information with error conditions
  ...
  Scenario Outline: Consume the message and process it and call charges data api getting 400 response moved to invalid
    ...
    Examples:
      ...
      | charges-delta-source-2.json    | 400              | charges-delta-charges-delta-consumer-invalid |
